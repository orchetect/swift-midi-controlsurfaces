...
extension HUIHostHelper {
    ...
    @HUIHostActor
    private func setupSingleBank(midiManager: ObservableMIDIManager) {
    ...
    @MainActor
    private func handle(inboundEvent event: HUISurfaceEvent) {
        switch event {
